...
class DeliriumBDinator:
    ...
    def __init__(self, *, username=None, password=None, database=None):
        ...
        if username and password and database:
            ...
            self.connection = self._get_connection(username, password, database)
    ...
    def get_user(self, vk_id: int):
        ...
        with self.connection, connection.cursor() as conn, cursor:
    ...
    def get_user_favorites(self, vk_id: int) -> list:
        """ данные об избранных пользователя по vk_id """
        with self.connection, connection.cursor() as conn, cursor:
    ...
    def add_user(self, vk_id, date, name=None, surname=None, birthday=None, age=None, sex=None, city=None, data=None):
    ...
    def add_favorites(self, user_id, favorites_id, date, name=None, surname=None, birthday=None, age=None, sex=None,
                      city=None, data=None):
    ...
    def update_favorites(self, vk_id, date, name=None, surname=None, birthday=None, age=None, sex=None, city=None,
                         data=None,
    ...
    def delete_favorites(self, user_id, favorites_id):
        ...
        with self.connection, connection.cursor() as conn, cursor:
            ...
            sql_search = "SELECT vk_id FROM user_favorites WHERE user_id = %s AND favorites_id=%s;"
            cursor.execute(sql_check, (user_id, favorites_id))
            ...
            sql_delete_f = "DELETE FROM favorites WHERE VALUES (%s,);"
...
def get_connection(self, *, username=None, password=None, database=None, hostname='localhost'):
    """ возвращает соединение с СУБД по настройкам возвращаемым
        getconfig """
    if not (username and password and database):
        dict_data = getconfig()
